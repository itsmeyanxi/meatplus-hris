...
// Grouping mirrors Sprout HR's top-nav menus (My Requests, Company,
// Administration Tools, Maintenance) so staff moving over from Sprout find
// things where they expect. "My Team" is omitted — our approval views live
// inside the request pages rather than a separate team area.
const NAV: NavItem[] = [
  // ── Home ──────────────────────────────────────────────────────────────────
  {
    href: "/dashboard",
  ...
  // ── My Team (department head / supervisor view) ───────────────────────────────
  {
    href: "/my-team",
    label: "My Team",
    group: "My Team",
    roles: ["dept_head", "supervisor", "team_lead"],
    requiresEmployee: true,
    badge: "approvals",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  {
    // Project-based crews (BLAST, ICE, CUTTER, …) — PASEI only, separated like agencies.
    href: "/crews",
    label: "Project Crews",
    group: "Company",
    permissions: ["employee.view"],
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-3.13a4 4 0 10-4-4 4 4 0 004 4zm6 0a3 3 0 10-2.83-4M9 12a3 3 0 100-6 3 3 0 000 6z" />
      </svg>
    ),
  },
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 16v-2l-8-5V3.5a1.5 1.5 0 00-3 0V9l-8 5v2l8-2.5V19l-2 1.5V22l3.5-1 3.5 1v-1.5L12 19v-5.5L21 16z" />
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.196-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118L2.98 9.771c-.783-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
      </svg>
    )
  },
  {
