...
export default function EmployeeRecordsPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <SectionShell index={6} icon={<IconEmployment />} title="Employment Record" description="Previous positions, companies & industries" defaultOpen={false}>
        <EmploymentRecordSection />
      </SectionShell>

      <SectionShell index={7} icon={<IconMovement />} title="Movement" description="Promotions, transfers & other movements" defaultOpen={false}>
        <MovementSection />
      </SectionShell>

      <SectionShell index={8} icon={<IconDocuments />} title="Documents" description="Uploaded employee documents" defaultOpen={false}>
        <DocumentsSection />
      </SectionShell>

      <SectionShell index={9} icon={<IconMedical />} title="Medical Records" description="Medical files & classifications" defaultOpen={false}>
        <MedicalRecordsSection />
      </SectionShell>

      <SectionShell index={10} icon={<IconRequirements />} title="Requirements" description="Pre-employment requirements checklist" defaultOpen={false}>
        <RequirementsSection />
      </SectionShell>

      <SectionShell index={11} icon={<IconKey />} title="Access Level" description="System login and access level" defaultOpen={false}>
        <AccessLevelSection />
      </SectionShell>
    </div>
  );
