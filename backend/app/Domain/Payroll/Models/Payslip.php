...
class Payslip extends Model
{
    ...
    protected $fillable = [
        ...
        'basic_pay', 'overtime_pay', 'night_diff_pay', 'holiday_pay', 'rest_day_pay', 'other_earnings', 'allowance', 'de_minimis',
        'communication_allowance', 'transportation_allowance', 'daily_allowance', 'gross_pay',
