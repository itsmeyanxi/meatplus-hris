...
class FinalPayController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'thirteenth_month_pay'     => 'required|numeric|min:0',
            'leave_conversion'         => 'required|numeric|min:0',  // sum of all leave items
            'unused_leave_days'        => 'required|numeric|min:0',  // total days
            'separation_pay'           => 'required|numeric|min:0',
        ...
        $finalPay = FinalPay::create([
            ...
            'leave_conversion'        => $data['leave_conversion'],
            'separation_pay'          => $data['separation_pay'],
